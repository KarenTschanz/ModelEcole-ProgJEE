...
class ChambreDAOTest {
	...
	@Test
	void testgetChambreByNoListInt() {
		...
		try {
			...
			assertEquals(lstref.get(i).getPrix(),ChambreDAO.getChambreByNoList(1));
		...
		for( int i = 0; i < lstref.size(); i++ )
		 {  
			 assertEquals(lstref.get(i).getNo(),ChambreDAO.getChambreByNoList().get(i).getNo());
			 assertEquals(lstref.get(i).getNum(),ChambreDAO.getChambreByNoList().get(i).getNum());
			 assertEquals(lstref.get(i).getPrix(),ChambreDAO.getChambreByNoList().get(i).getPrix());
		 }
	...
	void testGetChambreByNum() {
		...
		for(int i= 0;i<lstref.size();i++) {
			assertEquals(lstref.get(i).getNo(),ChambreDAO.getChambreByNum().get(i).getNo());
			assertEquals(lstref.get(i).getNum(),ChambreDAO.getChambreByNum().get(i).getNum());
			assertEquals(lstref.get(i).getPrix(),ChambreDAO.getChambreByNum().get(i).getPrix());
		}
	}
